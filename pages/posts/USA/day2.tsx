                    ...
                    <article className={"mb-5 flex flex-col"}>
                        ...
                        <div className={"flex justify-between flex-wrap"}>
                            ...
                            <div className="mt-3 md:mt-0 md:w-5/12">
                                ...
                                <p className={"text-s text-gray-300"}>After all the great information we had about Palo Alto we went to Microsoft. Here we met up with a person that was born Belgium (<a href="https://www.linkedin.com/in/nills/">Nills</a>) and now lives in the USA.
                                ...
                                This was just a nice Apple store with an AR table that turned alive with a Ipad.</p>
                            </div>
                        </div>
