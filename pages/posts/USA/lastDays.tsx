                    ...
                    <article className={"mb-5 flex flex-col"}>
                        ...
                        <div className={"flex justify-between flex-wrap"}>
                            <div className="mt-3 md:mt-0 md:w-5/12">
                                ...
                                <p className={"text-s text-gray-300"}>Day 4 started with a morning walk to a locale marketplace where we could buy some food. After this we went to Cloudflare. Cloudflare is a company that provides content delivery network services, DDoS mitigation, Internet security and distributed domain name server services. &nbsp;
                        ...
                        <p className={"text-s text-gray-300"}>This trip was one of the must interesting journey i ever had. I have learned a lot of new information and made some friends along the way. A huge thanks to HoWest and the lectors for organising suck a great trip! :) </p>
                    </article>
                </div>
            </main>
            <MainFooter/>
