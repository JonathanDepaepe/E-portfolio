            ...
            <main className={"bg-zinc-700 text-white h-12/12"}>
                <div className={"flex w-page90 md:w-page70 mr-auto ml-auto flex-col max-w-page"}>
                    ...
                    <article className={"mb-5 flex flex-col"}>
                        ...
                        <p className={"text-s text-gray-300 mb-7"}>Day 1 started very early and was a long day.We had to be in Bruges at 1AM to get our flight at 9am. The Fligt was 11 hours and when we arrived the time went 9 hours back.
                        ...
                        <div className={"flex justify-between flex-wrap"}>
                            <div className="mt-3 md:mt-0 md:w-5/12">
                                ...
                                <p className={"text-s text-gray-300"}>It all started monday morning at 1AM, Here we took a bus in Bruges at 1AM to go to Kortrijk to pick up the rest of the group.
                                    When everyone arrived we drove to Paris to get a flight to San Francisco. The flight itself was at 9AM and was a 11 hour flight.
                            ...
                            <div className="mt-3 md:mt-0 md:w-5/12">
                                ...
                                rooms were not ready yet. So instead we went to a nearby mobile provider to get the people that did not have a sim yet a sim card. After this we toke one of the oldest streetcars to go to the pier.
                                Here on the pier we took a group pic and after we had free to get food for.</p>
                            </div>
                        </div>
