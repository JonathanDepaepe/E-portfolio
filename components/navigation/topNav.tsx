            ...
            <nav className={"bg-zinc-800 text-white "}>
                <div className="flex pt-5 pl-5 border-b border-b-zinc-600 pb-5">
                    <div className="flex h-fit mt-auto mb-auto">
                        ...
                        <Link className="m-1" target="_blank" href={"https://www.instagram.com/jonathan.depaepe/"}><FontAwesomeIcon icon={faInstagram}/></Link>
                        <Link className="m-1" target="_blank" href={"https://github.com/silentz420"}><FontAwesomeIcon icon={faGithub}/></Link>
                        <Link className="m-1" target="_blank" href={"https://twitter.com/silentz420"}><FontAwesomeIcon icon={faTwitter}/></Link>
                    </div>
                ...
                <div className={"mt-3 pb-3 flex w-5/12 justify-around ml-auto mr-auto"}>
                    <Link className={"border-b-2 b- border-teal-600"} href={"#"}>Home</Link>
